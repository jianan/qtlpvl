test.pleio.vs.2qtl.simu <- function(cross, Y, E.marker, chr="6", addcov=NULL, intcov=NULL,
  ...
  for(i.simu in 1:n.simu){
    ...
    Y.simu <- Y.fit + mat
    result.i <- test.pleio.vs.2qtl(cross, Y.simu, chr=chr, addcov=addcov, intcov=intcov,
