...
work).
The additive QTL effect is defined as $a=(RR-BB)/2$. The dominance effect is
$d=BR-(BB+RR)/2$. When plotted against each other, traits
...
QTL genotypes, and
calculate the mean trait value for each of the 3 genotype group. We define the
